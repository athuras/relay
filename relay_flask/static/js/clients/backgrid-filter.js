...
(function(root, factory) {
  ...
  */
    var ServerSideFilter = Backgrid.Extension.ServerSideFilter = Backbone.View.extend({
        ...
        template: _.template('<span class="search">&nbsp;</span><input type="search" <% if (placeholder) { %> placeholder="<%- placeholder %>" <% } %> name="<%- name %>" /><a class="clear" data-backgrid-action="clear" href="#">&times;</a>', null, {
            variable: null
        }),
