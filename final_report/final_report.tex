...
Only through emergent prediction and reinforcement learning should Agent's behaviour diverge.
...
\subsubsection{Functional Requirements of the Agent Implementation}
The implementation must be able to do X, in order to meet the design goals specified above.
